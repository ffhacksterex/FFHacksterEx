========================================================================
    STATIC LIBRARY : ff1-editors Project Overview
========================================================================

AppWizard has created this ff1-editors library project for you.

This file contains a summary of what you will find in each of the files that
make up your ff1-editors application.
...
StdAfx.h, StdAfx.cpp
    ...
    named ff1-editors.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "ff1-editors.rc" and a "ff1-editors.h" that
