...
namespace {
	const int LAST_INI_VERSION = 9810;
...
bool Upgrades_ini::NeedsConversion(CString projectpath)
{
...
pair_result<CString> Upgrades_ini::UpgradeProject_none_to_1(int oldver, int newver, CString projectfolder, CString projectini)
{
...
pair_result<CString> Upgrades_ini::UpgradeProject_1_to_2(int oldver, int newver, CString projectfolder, CString projectini)
{
	UNREFERENCED_PARAMETER(oldver);
	UNREFERENCED_PARAMETER(newver);
...
pair_result<CString> Upgrades_ini::UpgradeProject_2_to_3(int oldver, int newver, CString projectfolder, CString projectini)
{
	UNREFERENCED_PARAMETER(oldver);
	UNREFERENCED_PARAMETER(newver);
...
pair_result<CString> Upgrades_ini::UpgradeProject_3_to_4(int oldver, int newver, CString projectfolder, CString projectini)
{
	UNREFERENCED_PARAMETER(oldver);
	UNREFERENCED_PARAMETER(newver);
...
pair_result<CString> Upgrades_ini::UpgradeProject_4_to_5(int oldver, int newver, CString projectfolder, CString projectini)
{
	UNREFERENCED_PARAMETER(oldver);
...
pair_result<CString> Upgrades_ini::UpgradeProject_5_to_6(int oldver, int newver, CString projectfolder, CString projectini)
{
	UNREFERENCED_PARAMETER(oldver);
	UNREFERENCED_PARAMETER(newver);
...
pair_result<CString> Upgrades_ini::UpgradeProject_6_to_7(int oldver, int newver, CString projectfolder, CString projectini)
{
	UNREFERENCED_PARAMETER(oldver);
	UNREFERENCED_PARAMETER(newver);
...
pair_result<CString> Upgrades_ini::UpgradeProject_7_to_8(int oldver, int newver, CString projectfolder, CString projectini)
{
	UNREFERENCED_PARAMETER(oldver);
	UNREFERENCED_PARAMETER(newver);
...
pair_result<CString> Upgrades_ini::UpgradeProject_8_to_9(int oldver, int newver, CString projectfolder, CString projectini)
{
	UNREFERENCED_PARAMETER(oldver);
	UNREFERENCED_PARAMETER(newver);
...
pair_result<CString> Upgrades_ini::UpgradeProject_9_to_10(int oldver, int newver, CString projectfolder, CString projectini)
{
	UNREFERENCED_PARAMETER(oldver);
	UNREFERENCED_PARAMETER(newver);
...
pair_result<CString> Upgrades_ini::UpgradeProject_10_to_971(int oldver, int newver, CString projectfolder, CString projectini)
{
	UNREFERENCED_PARAMETER(oldver);
	UNREFERENCED_PARAMETER(newver);
...
pair_result<CString> Upgrades_ini::UpgradeProject_971_to_9810(int oldver, int newver, CString projectfolder, CString projectini)
{
	UNREFERENCED_PARAMETER(oldver);
	UNREFERENCED_PARAMETER(newver);
