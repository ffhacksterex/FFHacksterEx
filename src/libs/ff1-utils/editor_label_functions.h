...
namespace Editorlabels
{
	namespace ffh2
	{
		...
		dataintnodevector LoadBattleLabelsEx(FFH2Project& proj, bool form2only, bool showindex = false);
		...
		dataintnodevector LoadEnemyCategoryLabels(FFH2Project& proj, bool showindex = false);
		dataintnodevector LoadFanfareLabels(FFH2Project& proj, bool showindex = false);
		dataintnodevector LoadFanfareTrueFalseLabels(FFH2Project& proj, bool showindex = false);
		dataintnodevector LoadMapLabels(FFH2Project& proj, bool showindex = false);
		dataintnodevector LoadMiscCoordLabels(FFH2Project& proj, bool showindex = false);
		dataintnodevector LoadNNTeleportLabels(FFH2Project& proj, bool showindex = false);
		dataintnodevector LoadNOTeleportLabels(FFH2Project& proj, bool showindex = false);
		dataintnodevector LoadONTeleportLabels(FFH2Project& proj, bool showindex = false);
		dataintnodevector LoadOnScreenSpriteLabels(FFH2Project& proj, bool showindex = false);
		dataintnodevector LoadShopLabels(FFH2Project& proj, bool showindex = false);
		dataintnodevector LoadSpecialTileLabels(FFH2Project& proj, bool showindex = false);
		dataintnodevector LoadSpriteGraphicLabels(FFH2Project& proj, bool showindex = false);
		dataintnodevector LoadSpriteLabels(FFH2Project& proj, bool showindex = false);
		dataintnodevector LoadTextLabels(FFH2Project& proj, bool showindex = false);
		dataintnodevector LoadTilesetLabels(FFH2Project& proj, bool showindex = false);
		dataintnodevector LoadTreasureLabels(FFH2Project& proj, bool showindex = false);
		dataintnodevector LoadWepMagicLabels(FFH2Project& proj, bool showindex = false);

		// ################################################################
		// SINGLE ENTRY READERS

		dataintnode LoadAILabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadAilEffectLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadArmorTypeLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadBackdropLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadBattleLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadBattleLabelEx(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadBattlePatternTableLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadElementLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadEnemyCategoryLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadFanfareLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadMapLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadMiscCoordLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadNNTeleportLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadNOTeleportLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadONTeleportLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadOnScreenSpriteLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadShopLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadSpecialTileLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadSpriteGraphicLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadSpriteLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadTextLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadTilesetLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadTreasureLabel(FFH2Project& proj, int index, bool showindex = false);
		dataintnode LoadWepMagicLabel(FFH2Project& proj, int index, bool showindex = false);
	}
}

namespace Labels2 = Editorlabels::ffh2;
