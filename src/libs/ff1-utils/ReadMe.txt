========================================================================
    STATIC LIBRARY : ff1-utils Project Overview
========================================================================

AppWizard has created this ff1-utils library project for you.

This file contains a summary of what you will find in each of the files that
make up your ff1-utils application.
...
StdAfx.h, StdAfx.cpp
    ...
    named ff1-utils.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "ff1-utils.rc" and a "ff1-utils.h" that
